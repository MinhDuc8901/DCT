...
while True:
    m = input(
        "Nhấn'1' giấu tin trong ảnh, Nhấn'2' giải mã thông điệp được giấu trong ảnh, Nhấn phím bất kỳ để thoát khỏi trương trình: ")
    ...
    if m == "1":
        ...
        secret_msg = input("Nhập thông điệp: ")
        ...
        file.close()
        print("Thông điệp: "+dct_hidden_text)
        os.chdir("..")
    else:
        print("Closed!")
        break
